...
<tr><td><a href="http://godoc.org/github.com/gogo/protobuf/gogoproto">nopointer</a></td><td> Field </td><td> bool </td><td> if false, a field is generated without a pointer (see warning below). This differs from nullable in that the marshal method follows proto3 semantics that default and empty values are equivalent and therefore the default value is not serialized.</td><td> false </td></tr>
