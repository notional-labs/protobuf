...
func TestNoPointerStructProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNoPointerStruct(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestNoPointerStructMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNoPointerStruct(popr, false)
	size := p.Size()
...
func BenchmarkNoPointerStructProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*NoPointerStruct, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedNoPointerStruct(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkNoPointerStructProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedNoPointerStruct(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestNoPointerStructJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNoPointerStruct(popr, true)
	marshaler := github_com_gogo_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestNoPointerStructProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNoPointerStruct(popr, true)
	dAtA := github_com_gogo_protobuf_proto.MarshalTextString(p)
...
func TestNoPointerStructProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNoPointerStruct(popr, true)
	dAtA := github_com_gogo_protobuf_proto.CompactTextString(p)
...
func TestNoPointerStructCompare(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNoPointerStruct(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
	...
	p2 := NewPopulatedNoPointerStruct(popr, false)
	c := p.Compare(p2)
	c2 := p2.Compare(p)
	if c != (-1 * c2) {
		t.Errorf("p.Compare(p2) = %d", c)
...
func TestNoPointerStructVerboseEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNoPointerStruct(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
...
func TestNoPointerStructFace(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNoPointerStruct(popr, true)
	msg := p.TestProto()
	if !p.Equal(msg) {
...
func TestNoPointerStructGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNoPointerStruct(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestNoPointerStructSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedNoPointerStruct(popr, true)
	size2 := github_com_gogo_protobuf_proto.Size(p)
...
func BenchmarkNoPointerStructSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*NoPointerStruct, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedNoPointerStruct(popr, false)
	}
	b.ResetTimer()
...
func TestNoPointerStructStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedNoPointerStruct(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
